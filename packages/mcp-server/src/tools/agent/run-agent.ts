...
export const tool: Tool = {
  name: 'run_agent',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nRun an agent with the specified task.\n\n# Response Schema\n```json\n{\n  type: 'object',\n  title: 'AgentCompletionOutput',\n  properties: {\n    id: {\n      type: 'string',\n      title: 'Id',\n      description: 'The unique identifier for the agent completion.'\n    },\n    description: {\n      type: 'string',\n      title: 'Description',\n      description: 'A description of the agent or completion.'\n    },\n    name: {\n      type: 'string',\n      title: 'Name',\n      description: 'The name of the agent.'\n    },\n    outputs: {\n      type: 'object',\n      title: 'Outputs',\n      description: 'The outputs generated by the agent.'\n    },\n    success: {\n      type: 'boolean',\n      title: 'Success',\n      description: 'Indicates whether the agent completion was successful.'\n    },\n    temperature: {\n      type: 'number',\n      title: 'Temperature',\n      description: 'The temperature setting used for the agent\\'s response generation.'\n    },\n    timestamp: {\n      type: 'string',\n      title: 'Timestamp',\n      description: 'The timestamp when the agent completion was created.'\n    },\n    usage: {\n      type: 'object',\n      title: 'Usage',\n      description: 'Usage statistics or metadata for the agent completion.'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      agent_config: {
...
export const handler = async (client: SwarmsClient, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.agent.run(body)));
};
