...
export const metadata: Metadata = {
  ...
  operationId: 'run_batched_grid_workflow_v1_batched_grid_workflow_completions_post',
};

export const tool: Tool = {
  name: 'complete_workflow_client_batched_grid_workflow',
  description:
  ...
  inputSchema: {
    ...
    properties: {
      agent_completions: {
        ...
        description: 'The agent completions to be completed by the batched grid workflow.',
        items: {
          $ref: '#/$defs/agent_spec',
        },
      },
      ...
      imgs: {
        type: 'array',
        title: 'Imgs',
        description: 'The images to be used by the batched grid workflow.',
        items: {
          type: 'string',
        },
      },
      max_loops: {
        type: 'integer',
        title: 'Max Loops',
        description: 'The maximum number of loops to be completed by the batched grid workflow.',
      },
      name: {
        type: 'string',
        title: 'Name',
        description: 'The name of the batched grid workflow.',
      },
      tasks: {
        type: 'array',
        title: 'Tasks',
        description: 'The tasks to be completed by the batched grid workflow.',
        items: {
          type: 'string',
        },
      },
