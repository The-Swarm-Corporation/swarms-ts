...
import { SwarmsClient, ClientOptions } from 'swarms-ts';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: SwarmsClient)`
    : `const run: (${functionSource.client}: SwarmsClient) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.swarms.checkAvailable',
    'client.swarms.getLogs',
    'client.swarms.run',
    'client.swarms.batch.run',
    ...
    'client.client.marketplace.createAgent',
    'client.client.batchedGridWorkflow.completeWorkflow',
    'client.client.graphWorkflow.executeWorkflow',
  ],
