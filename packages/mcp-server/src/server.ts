...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/swarms',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the swarms MCP server. You will use Code Mode to help the user perform
